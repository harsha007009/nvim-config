    ...
    dashboard = {
      preset = {
        ...
        keys = {
          ...
          { icon = "󰂖 ", key = "x", desc = "Lazy Extras", action = ":LazyExtras", enabled = package.loaded.lazy ~= nil },
...
╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝
      ...
      sections = {
          ...
          pane = 2,
          section = 'terminal',
          cmd = "ascii-image-converter \"" .. vim.fn.stdpath('config') .. "\\images\\2099.jpeg\" --dimensions 50,25 --color --complex",
          height = 28,
          indent = 4
        },
